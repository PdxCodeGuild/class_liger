...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # with open('pokemon.json', 'w') as poke_balls:

        #     json.dump(f, poke_balls)
        ...
        for pokemon in poke_balls:
            ...
            poke_types, created = PokemonType.objects.get_or_create(name=types)

            PokemonType.name.add(poke_types)
